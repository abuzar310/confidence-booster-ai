...
**Project:** Confidence Booster
**Generated:** 2026-09-24 16:26:23
...
| Secondary | `#5E6AD2` | `--color-secondary` |
...
**Color Notes:** Auto table suggested studio violet + cyan. Override to phonk pink `#EC4899` + cinema indigo `#5E6AD2` — see `design-system/MASTER.md`.
